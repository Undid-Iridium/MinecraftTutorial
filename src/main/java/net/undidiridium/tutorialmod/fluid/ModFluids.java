package net.undidiridium.tutorialmod.fluid;
...
public class ModFluids {
    ...
    /**
     * ARGB BF (A) FCBA03 (RGB)
     */
    private static final int color = 0xbffcba03;
    ...
    public static final ForgeFlowingFluid.Properties HONEY_PROPERTIES = new ForgeFlowingFluid.Properties(
            () -> HONEY_FLUID.get(), () -> HONEY_FLOWING.get(), FluidAttributes.builder(WATER_STILL_RL,
                    WATER_FLOWING_RL)
            .density(15).luminosity(2).viscosity(5).sound(SoundEvents.HONEY_DRINK).overlay(WATER_OVERLAY_RL)
            .color(color)).slopeFindDistance(2).levelDecreasePerBlock(2)
