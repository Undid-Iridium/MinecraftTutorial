...
public class ModItems {
    ...
    public static final RegistryObject<Item> DOWSING_ROD_ADV =
            ITEMS.register("dowsing_rod_adv",
                    () -> new DowsingRodItemAdvanced(new Item.Properties().tab(ModCreativeModeTab.TUTORIAL_TAB).durability(16)));
    ...
    public static final RegistryObject<Item> CITRINE_SWORD =
            ITEMS.register("citrine_sword", () -> new LevitationSwordItem(ModTiers.CITRINE, 2, 3f,
                    new Item.Properties().tab(ModCreativeModeTab.TUTORIAL_TAB)));
    public static final RegistryObject<Item> CITRINE_PICKAXE =
            ITEMS.register("citrine_pickaxe", () -> new PickaxeItem(ModTiers.CITRINE, 1, 1f,
                    new Item.Properties().tab(ModCreativeModeTab.TUTORIAL_TAB)));
    public static final RegistryObject<Item> CITRINE_SHOVEL =
            ITEMS.register("citrine_shovel", () -> new ShovelItem(ModTiers.CITRINE, 0, 1f,
                    new Item.Properties().tab(ModCreativeModeTab.TUTORIAL_TAB)));
    public static final RegistryObject<Item> CITRINE_AXE =
            ITEMS.register("citrine_axe", () -> new AxeItem(ModTiers.CITRINE, 4, 0f,
                    new Item.Properties().tab(ModCreativeModeTab.TUTORIAL_TAB)));
    public static final RegistryObject<Item> CITRINE_HOE =
            ITEMS.register("citrine_hoe", () -> new HoeItem(ModTiers.CITRINE, 0, 0f,
                    new Item.Properties().tab(ModCreativeModeTab.TUTORIAL_TAB)));
    ...
    public static final RegistryObject<Item> AFTER_DARK_MUSIC_DISK = ITEMS.register("after_dark_music_disc",
            () -> new RecordItem(4, ModSounds.AFTER_DARK,
                    new Item.Properties().tab(ModCreativeModeTab.TUTORIAL_TAB).stacksTo(1)));
